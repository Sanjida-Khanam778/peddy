...
const showAllPets = (pets) => {
  ...
  if (pets.length === 0) {
    ...
    <p class = "text-tex_light xl:text-center xl:w-3/4 ">Sorry, no pets are currently available in this category. Please check back later or explore other categories to find your perfect companion.</p>
    `;
    return;
  } else {
  ...
  pets.forEach((pet) => {
    ...
    div1.innerHTML = `
              ...
              <div class = "lg:h-44"><img class = "rounded-lg w-full h-full object-cover" src=${pet.image}/></div>
